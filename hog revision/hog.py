...
def play(strategy0, strategy1):
    ...
    "*** YOUR CODE HERE ***"
    def TurnHelper (score0,score1,strategy):
        dice_number= strategy(score0, score1)
        if dice_number>num_allowed_dice(score0, score1):
            dice_number=num_allowed_dice(score0, score1)
        return take_turn(dice_number, score0, select_dice(score0, score1), 0)
    ...
    while score0<100 and score1<100:
        if who==0:
            score0+=TurnHelper(score0,score1,strategy0)
            who=1
            
        elif who==1:
            score1+=TurnHelper(score1,score0,strategy1)
            who=0
